  ...
  return (
            ...
            <div>
              ...
              <div className="card">
                ...
                <h1>Success</h1> 
                <p>Ihre Anfrage zum Verkauf eines Telefons ist eingegangen;<br /> Bitte überprüfen Sie Ihre Mailbox. Wir haben dir ein dhl-tag geschickt, das du verwenden kannst </p>
                <br></br>
                <button onClick={()=>{  
            navigate("/");
