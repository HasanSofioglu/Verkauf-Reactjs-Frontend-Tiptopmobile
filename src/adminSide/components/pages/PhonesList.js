...
fetchMyAPI()
    ...
    return(
      ...
      <div >
        <a href="javascript:void(deletePhone(val.id))" className="button icon-button"  aria-label="Icon-only Button" viewBox="0 0 32 32" style={{backgroundColor : 'red'}}>
          <svg xmlns="http://www.w3.org/2000/svg"  aria-hidden="trnpue" className="icon-button__icon"  focusable="false">
